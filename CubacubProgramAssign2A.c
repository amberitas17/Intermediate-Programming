/* CQPA Calculator Program (with conditionals)
Written by: Amber Clarisse Cubacub
Date Written: 02/23/22 */
#include <stdio.h>
...
int main(void) {
	...
	else if (cqpa >= 2.0 && cqpa <= 2.9) {
		printf("\nYour CQPA is okay but you can do better than this.");
	}
	else if (cqpa >= 1.0 && cqpa <= 1.9) {
		printf("\nYou have a low CQPA, you need to take a remedial course.");
	}
	else {
